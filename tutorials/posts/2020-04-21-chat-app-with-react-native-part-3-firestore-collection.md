...
slug: chat-app-with-react-native-part-3-firestore-collection
categories:
  - React Native
  - Firebase
tags:
...
![cover_image](https://miro.medium.com/max/1400/1*cpeZGGHWD8y_Ura5MJqjyg.jpeg)

In [part 2](https://amanhimself.dev/chat-app-with-react-native-part-2-email-authentication) of this series, we made progress with the chat app by adding email authentication using the real-time auth service from Firebase. This ensures that we have a system in place to authenticate users.
