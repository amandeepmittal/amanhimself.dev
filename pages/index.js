      ...
      <TWContainer as="main" noMargin className="md:px-4 space-y-14">
        ...
        <Container>
          <Stack
            ...
            <Text color={secondaryTextColor} mb={2} fontSize="md">
              Other notable publications: Hackernoon, Rising Stack,
            ...
            <Text color={secondaryTextColor} mb={2} fontSize="md">
              ...
              Reactjs and Web Development in general. More than 1000+ devs have
              signed up.
            </Text>
            <Heading letterSpacing="tight" mt={8} mb={2} as="h2" size="xl">
              Work History
            ...
            <Text color={secondaryTextColor} mb={2} fontSize="md">
              ...
              <List styleType="disc" mb={3}>
                <ListItem>
                  Crowdbotics (Full-Stack role, Technical Writer, 2018 -
                  Present)
                </ListItem>
