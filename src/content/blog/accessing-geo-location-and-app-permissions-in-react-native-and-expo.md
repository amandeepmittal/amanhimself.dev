...
![App.js source code for the find-me Expo project](https://i.imgur.com/kWvPIWF.png)

Create a new file for the `FindMe` component at `src -> screens -> FindMe -> index.js`. Inside this file, we will just display a text.

![FindMe component code rendering a single text element](https://i.imgur.com/rRRzQVb.png)

Here is how our app looks so far.

![find-me app running in the simulator with placeholder text](https://i.imgur.com/9oCTyax.png)
...
![getCurrentPosition call with success, error, and configuration parameters](https://i.imgur.com/oeYTXrk.png)
...
![FindMe component code with the findCurrentLocation function added](https://i.imgur.com/totMaU5.png)
...
![find-me app showing the tappable Where Am I text](https://i.imgur.com/Wj58GJo.png)
...
![FindMe component code using Expo Permissions and getCurrentPositionAsync](https://i.imgur.com/e4InNct.png)
...
![app.json with the Android location permission added](https://i.imgur.com/NvFVYyw.png)
![Permission prompt asking to allow find-me to access location](https://i.imgur.com/gov0n1z.png)

If you press allow, you will see the following result.

![find-me app displaying the fetched latitude and longitude coordinates](https://i.imgur.com/hEh9YBC.png)
...
![react-native-cli project structure with separate android and ios folders](https://i.imgur.com/MOyLOFw.png)

We will only modify `App.js` file with the following code.

![App.js code with the findCoordinates function for findCoordsApp](https://i.imgur.com/CPryJLE.png)
...
![info.plist with the location usage description key added](https://i.imgur.com/Iqc2Y2c.png)
...
![AndroidManifest.xml with the ACCESS_FINE_LOCATION permission added](https://i.imgur.com/eqkj6TT.png)

Now if you run your application you will see the following screen.

![findCoordsApp running on the Android emulator before tapping the text](https://i.imgur.com/528AV75.png)
...
![Android emulator prompting to allow findCoordsApp to access location](https://i.imgur.com/RVPukGJ.png)

If you press allow, you will see the following result.

![findCoordsApp showing coordinates after location permission is granted](https://i.imgur.com/z7MQSko.png)
