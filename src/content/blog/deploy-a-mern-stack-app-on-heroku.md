...
<img src='https://cdn-images-1.medium.com/max/800/1*fza80DTPXuhFwJapj2ZIbQ.png' alt="Express server running at localhost:5000 in the browser" />
...
<img src='https://cdn-images-1.medium.com/max/800/1*gnhdXtIORiT1EsMEv3MSUg.png' alt="mLab dashboard listing existing MongoDB sandbox deployments" />
...
<img src='https://cdn-images-1.medium.com/max/800/1*LiDzbwLDCpC-e4Igs7qptg.png' alt="Choosing the free Sandbox plan type for a new MongoDB deployment" />
...
<img src='https://cdn-images-1.medium.com/max/800/1*GyHzO_0P76__Y6_UOG1zXA.png' alt="mLab Users tab with the Add database user dialog open" />
...
<img src='https://cdn-images-1.medium.com/max/800/1*560qCrzs2900Z2zqwUK2oA.png' alt="Terminal confirming the server connected to the MongoDB database" />
...
<img src='https://cdn-images-1.medium.com/max/800/1*K5i8irozZCKYpIodE6hgng.png' alt="New build directory created inside the client folder after yarn build" />
...
<img src='https://cdn-images-1.medium.com/max/800/1*V3ZbTRYfdUc2jnEWHsPEdQ.png' alt="MERN book list app served from localhost:5000" />
...
<img src='https://cdn-images-1.medium.com/max/800/1*mNSQyfBe_qzh_IyUZdaT_w.png' alt="books collection appearing in the mLab MongoDB deployment" />

I already have two records.

<img src='https://cdn-images-1.medium.com/max/800/1*dfYnIQotE5nFr3UhkDIb9g.png' alt="Two book records stored in the books collection" />

<img src='https://cdn-images-1.medium.com/max/800/1*mauB7W6yd80fS5gmWHomPA.png' alt="Fields of a single book document stored in MongoDB" />
...
<img src='https://cdn-images-1.medium.com/max/800/1*Tfgopqciv5qCw_YzDXOM6A.png' alt="Terminal signing in to Heroku with the heroku login command" />
...
<img src='https://cdn-images-1.medium.com/max/800/1*75t_1Se-SNCHrQ67CIKwmQ.png' alt="heroku create output showing the generated app id and URL" />
...
<img src='https://cdn-images-1.medium.com/max/800/1*jsmi-MziaelOUtB_2Mbn4Q.png' alt="Terminal output of a finished git push heroku master build" />
...
<img src='https://cdn-images-1.medium.com/max/800/1*PQTWi9hFs29cI2B2IsRRDw.png' alt="Deployed MERN app on its Heroku URL showing the saved books" />
