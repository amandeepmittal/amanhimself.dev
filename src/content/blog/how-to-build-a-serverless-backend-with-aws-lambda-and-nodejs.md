...
<img src='https://cdn-images-1.medium.com/max/1200/1*a8oVpnOEISTzsuLEH9UaqA.png' alt="Syntax of a typical Lambda handler function in a Node.js server" />
...
<img src='https://cdn-images-1.medium.com/max/1200/1*Z_nBXZzDdIuiuM6JdFGqGA.png' alt="AWS console welcome screen after finishing account verification" />
...
<img src='https://cdn-images-1.medium.com/max/1200/1*PHUnYi1euJNBo1DCgIP2Sw.png' alt="IAM Add user form with programmatic access enabled" />

Then on the next page, select `Attach Existing Policies Directly` and then select a policy name `AdministratorAccess`.

<img src='https://cdn-images-1.medium.com/max/1200/1*ZwcXfwj7ZtSW6PzZxGJDNQ.png' alt="IAM policy list with AdministratorAccess selected for the new user" />
...
<img src='https://cdn-images-1.medium.com/max/1200/1*J5dUlRdUkpTqNY2POPK7ag.png' alt="Terminal listing the commands available in the serverless framework" />
...
<img src='https://cdn-images-1.medium.com/max/800/1*b8xegxAg6xjsMC4CHFsYzA.png' alt="AWS page offering the new user access keys for download" />

You can also visit your username and visit _Security Credentials_ like below.

<img src='https://cdn-images-1.medium.com/max/1200/1*9M0Nb4QTI9gFxoG1wVh1jA.png' alt="AWS account menu with the Security Credentials option highlighted" />
...
<img src='https://cdn-images-1.medium.com/max/800/1*uqlYKZAAgpDAWmXhN8mB0A.png' alt="Terminal success message after configuring AWS credentials with serverless" />
...
<img src='https://cdn-images-1.medium.com/max/800/1*m2FL-IdSqaFhKMuSmKnT_Q.png' alt="Service Information output in the terminal after running sls deploy" />
...
<img src='https://cdn-images-1.medium.com/max/800/1*W_iWmZ_bVhyjp7mfbmBN6Q.png' alt="Terminal output returned by invoking the hello function" />
...
<img src='https://cdn-images-1.medium.com/max/800/1*7W3seaSdt-J2JfQYHidnhQ.png' alt="MongoDB Atlas account page for adding a new organization" />

Now, after entering the name, proceed further and click on _Create Organization_.

<img src='https://cdn-images-1.medium.com/max/800/1*PfITUpnG3MXuQz23mskXNQ.png' alt="MongoDB Atlas organization form with the Create Organization button" />
...
<img src='https://cdn-images-1.medium.com/max/800/1*d9BZjyAy5FPLB7TEXq3Ccw.png' alt="MongoDB Atlas screen for naming a new project" />
...
<img src='https://cdn-images-1.medium.com/max/800/1*h1fSIz3G3svG6wzTCATiAA.png' alt="MongoDB Atlas permissions screen with the database name field" />

Now, we can add our free sandbox to this project. It is called a cluster.

<img src='https://cdn-images-1.medium.com/max/800/1*1PO22dNYhGRkSzuwEilmFg.png' alt="MongoDB Atlas screen for adding a free sandbox cluster" />
...
<img src='https://cdn-images-1.medium.com/max/800/1*tu5gwq1g-L_nWjpfUEz_ag.png' alt="MongoDB Atlas connect dialog with the Allow Access From Anywhere option" />

<img src='https://cdn-images-1.medium.com/max/800/1*sMkkGj1_unFYQveVf2Huew.png' alt="MongoDB connection URL shown in the Atlas connect dialog" />
...
<img src='https://cdn-images-1.medium.com/max/800/1*vNUMO69rnmx5y-QF3Kr6-Q.png' alt="Terminal listing a REST endpoint deployed for each handler function" />
