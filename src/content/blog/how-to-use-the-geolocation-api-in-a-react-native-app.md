...
<img src='https://cdn-images-1.medium.com/max/800/1*PMstW38hq0Zza4T8mZr6qg.png' alt="Finished React Native weather app showing the current forecast" />
...
<img src='https://cdn-images-1.medium.com/max/800/1*T3QXVm1-unXEjKEZhmKo7A.png' alt="Default React Native welcome screen for geoWeatherApp in the iOS simulator" />
...
<img src='https://cdn-images-1.medium.com/max/800/1*LmcWwnrsZOXkGbmagtx7Mw.png' alt="App screen with the touchable Find My Coords? text" />
...
<img src='https://cdn-images-1.medium.com/max/800/1*72jjzVbVBLl-mTdk_vMA7w.png' alt="iOS prompt asking permission to access the device location" />
...
<img src='https://cdn-images-1.medium.com/max/800/1*K5bwsAxiRQm0Z2qImvniaA.png' alt="Position object returned by getCurrentPosition displayed in the app" />
...
<img src='https://cdn-images-1.medium.com/max/800/1*2be8SbVAPPukbDgPUsl29g.png' alt="info.plist containing the location usage description key" />
...
<img src='https://cdn-images-1.medium.com/max/800/1*lDejJzVSE6YGIRGT_Lgbjw.png' alt="AndroidManifest.xml with the ACCESS_FINE_LOCATION permission added" />
...
<img src='https://cdn-images-1.medium.com/max/800/1*gJVJOiCG4NO45iEnmwfdtA.png' alt="Android emulator prompting to allow the app to access location" />

If you press allow, you’ll see the following result.

<img src='https://cdn-images-1.medium.com/max/800/1*H9Pj8TlBfWqlrtZfmPWteQ.png' alt="Coordinates displayed in the Android emulator after allowing access" />
...
<img src='https://cdn-images-1.medium.com/max/800/1*8yiknE8jK7gnClfanEsSfw.png' alt="OpenWeatherMap sign up page for getting an API key" />
...
<img src='https://cdn-images-1.medium.com/max/800/1*mXaHYMh_TgpEeJjrKFz2ug.png' alt="App rendering the Minimalist Weather App text" />
...
<img src='https://cdn-images-1.medium.com/max/800/1*fo8IAFglmCCWcBkSTiigLQ.png' alt="Loading screen shown when isLoading is set to true" />
...
<img src='https://cdn-images-1.medium.com/max/800/1*dOKWGbyK8rLkcJb57lE8YQ.png' alt="Weather component boilerplate with the header and body containers" />
...
<img src='https://cdn-images-1.medium.com/max/800/1*pIZuRJJlYJwrNkm2we-8PA.png' alt="Weather screen with the sunny icon, temperature, and subtitle" />
...
<img src='https://cdn-images-1.medium.com/max/800/1*Z6Nv_m3cBRuj9w5qwiJStw.png' alt="Weather screen background and icon changing with the weather condition" />
