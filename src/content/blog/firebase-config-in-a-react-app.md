...
![Default create-react-app page at localhost:3000](https://i.imgur.com/KMW1O19.png)
...
![Basic src directory setup used for a React app with Firebase](https://i.imgur.com/4EXRxj8.png)
...
![Browser showing the React App heading after editing App.js](https://i.imgur.com/fk5pNaU.png)
...
![SignIn, SignOut and SignUp folders inside src/components](https://i.imgur.com/Fh4Ha83.png)
...
![Optional src/Pages directory holding Home and Landing components](https://i.imgur.com/NOdfdO3.png)
...
![Settings icon in the Firebase dashboard side menu](https://i.imgur.com/zkv9SNA.png)

The _Settings_ page opens as shown below.

![Firebase project Settings page](https://i.imgur.com/ZTgOnQk.png)
...
![Your apps section with the Web icon beside the iOS and Android icons](https://i.imgur.com/FGaubt7.png)

Next, there is going to be a prompt about adding the name of the web app. Enter a name.

![Prompt asking for the name of the new web app](https://i.imgur.com/m2mhbm6.png)
...
![Generated firebaseConfig object with the key values blacked out](https://i.imgur.com/NGYOauf.png)
...
![Browser Console tab logging the object returned by Firebase](https://i.imgur.com/Nl4Mov8.png)
