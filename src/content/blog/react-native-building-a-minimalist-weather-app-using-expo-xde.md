...
<img src='https://cdn-images-1.medium.com/max/800/0*6kAET2qSInCk6rtP.png' alt="Expo XDE start screen with the Create New Project button" />
...
<img src='https://cdn-images-1.medium.com/max/800/0*NyV0f0GPNVnTeJHd.png' alt="Expo XDE dialog for naming the new project in lowercase" />
![Expo XDE creating the project and installing its dependencies](https://cdn-images-1.medium.com/max/800/0*JIjaFynv5BRNDAh4.png)
...
<img src='https://cdn-images-1.medium.com/max/800/0*ft82CkCgUzl2AFoj.png' alt="Expo XDE option to open the generated app in a simulator" />
...
<img src='https://cdn-images-1.medium.com/max/800/0*gp1nRwd4sg051Weh.png' alt="QR code in Expo XDE for opening the app in the Expo client" />

Once, bundling of the source code is done you will be prompt with a success message on the Expo XDE terminal:

<img src='https://cdn-images-1.medium.com/max/800/0*1pOjz1x6gdMbCuxJ.png' alt="Expo XDE terminal reporting that bundling finished successfully" />

And you will be able to see that our default app is running on the device:

<img src='https://cdn-images-1.medium.com/max/800/0*vvy0yzLxdw5BHhIy.png' alt="Expo client loading the default app on a real device" />

<img src='https://cdn-images-1.medium.com/max/800/0*VQREoYLkE45Iw2Ku.png' alt="Default app screen rendering the text from App.js" />
...
<img src='https://cdn-images-1.medium.com/max/800/0*HGCr4kSfTugsZq9-.png' alt="App live reloading to show the Minimalist Weather App text" />
...
<img src='https://cdn-images-1.medium.com/max/800/0*1ii9x6Eoi02W3d6h.png' alt="Loading screen displaying the Fetching The Weather message" />
...
<img src='https://cdn-images-1.medium.com/max/800/0*cpkJvjx_VETikRV5.png' alt="Weather component prototype with a sunny icon on an orange background" />
...
<img src='https://cdn-images-1.medium.com/max/800/0*IUfQ_1hTKAa-U0m4.png' alt="Weather screen showing the real temperature and condition from the API" />
...
<img src='https://cdn-images-1.medium.com/max/600/0*xjM1JAPtNLWtzvau.gif' alt="Finished app changing background, icon, and text per weather condition" />
