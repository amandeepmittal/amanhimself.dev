...
![Create React App boilerplate page running in the browser](https://i.imgur.com/3vGXI94.png)
...
![Home page of the single page app with the About link](https://i.imgur.com/qdqY2YP.png)
...
![Lighthouse extension popup with the Generate Report button](https://i.imgur.com/c3oDUYx.png)
...
![First Lighthouse report with a low progressive web app score](https://i.imgur.com/khE0Q5o.png)
![Failed audits listed in the first Lighthouse report](https://i.imgur.com/8OjdMK4.png)
...
![Chrome DevTools console confirming the service worker registration](https://i.imgur.com/HRVYgGB.png)

If we run the Lighthouse audit process again, I hope we will get a better result.

![Second Lighthouse audit with the service worker check passing](https://i.imgur.com/xaTMUez.png)
...
![Lighthouse scores after adding the inline CSS and loading message](https://i.imgur.com/lHn2hZG.png)
...
![Lighthouse audit with the web app manifest issue resolved](https://i.imgur.com/zyot782.png)
...
![Firebase CLI prompting to select a project to deploy](https://i.imgur.com/0cg1Dtt.png)
![Firebase CLI hosting setup prompts in the terminal](https://i.imgur.com/7pg1Di0.png)
![Firebase CLI hosting setup prompts in the terminal](https://i.imgur.com/7pg1Di0.png)
...
![Lighthouse report with a 100 progressive web app score](https://i.imgur.com/VSEWUqI.png)
![Final Lighthouse audit with every check under passed audits](https://i.imgur.com/2GJL7m5.png)
