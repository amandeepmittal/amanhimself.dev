    ...
    <article>
      ...
      <div className='page'>
        ...
        <p>
          ...
          educative learning platform Zeolearn on Nodejs.
        </p>
        <h4>Me & Open Source</h4>
        <p>
          I frequently contribute to Open Source community and have been active
          in #100DaysOfCode, freeCodeCamp, Node.js, and GatsbyJS.
        </p>
        <p>
          ...
          <a
            ...
            target='_blank'
            rel='noopener noreferrer'
          >{` Top 200 Open Source Contributors by
          freeCodeCamp.org in 2018`}</a>
          .
        </p>
        <h4>Other stuff I am passionate about</h4>
        <p>
          When I am not writing code, or writing about code, I like to spend my
          time with books (
          <a
        ...
        <span>Unique Touch Solutions (2016 - 2017)</span>
        <ul>
        ...
        <ul>
          <p>Contributions</p>
          <li>
            <strong>freeCodeCamp (2017- present):</strong> Creator/Maintainer of
            <a
              href='https://github.com/freeCodeCamp/100DaysOfCode-twitter-bot'
              target='_blank'
              rel='noopener noreferrer'
            ...
            Twitter bot followed by more than <strong>75k+ developers</strong>.
          </li>
          <li>
            <strong>Gatsbyjs:</strong> Creator of 4 starter/theme kits.
          </li>
          <li>
            <strong>Nodejs:</strong> Contributor/Maintainer of Nodejs.org
            website.
          </li>
        </ul>
        ...
        <h2>{`🎧 Guest Podcast Appearance & Interviews`}</h2>
        <ul>
          <li>
            <a
              href='https://tinyletter.com/amanhimself'
