  ...
  return (
    <div className='container'>
      <div className='page'>
        ...
        <a
          href='https://twitter.com/haysstanford/status/1231109890275520512?ref_src=twsrc%5Etfw'
          target='_blank'
          rel='noopener noreferrer'
        >
          <img src={five} />
        ...
        <a
          href='https://twitter.com/ng_real_ninja/status/1242877351702089728?ref_src=twsrc%5Etfw'
          target='_blank'
          rel='noopener noreferrer'
        >
          <img src={three} />
        ...
        <a
          href='https://twitter.com/r4meau/status/1246823291127500800?ref_src=twsrc%5Etfw'
          target='_blank'
          rel='noopener noreferrer'
        >
          <img src={one} />
        ...
        <a
          href='https://twitter.com/tfmoliveira/status/1192758294957428737?ref_src=twsrc%5Etfw'
          target='_blank'
          rel='noopener noreferrer'
        >
          <img src={seven} />
        ...
        <a
          href='https://twitter.com/iambhavesh93/status/1236522522226462720?ref_src=twsrc%5Etfw'
          target='_blank'
          rel='noopener noreferrer'
        >
          <img src={eleven} />
        ...
        <a
          href='https://twitter.com/kpoosee/status/1231696910597132288?ref_src=twsrc%5Etfw'
          target='_blank'
          rel='noopener noreferrer'
        >
          <img src={twelve} />
        ...
        <a
          href='https://twitter.com/WajahatShaw/status/1221683137908019200?ref_src=twsrc%5Etfw'
          target='_blank'
          rel='noopener noreferrer'
        >
          <img src={fourteen} />
